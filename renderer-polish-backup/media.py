...
def _motion_filter(scene, frames: int, is_first: bool = False, is_last: bool = False) -> str:
    ...
    if motion == "dolly_out":
        ...
        zoom = "1.045"
        x = "iw/2-(iw/zoom/2)+8*sin(on/22)"
        y = "ih/2-(ih/zoom/2)+6*cos(on/27)"
    elif motion == "static":
        zoom = "1.02"
        x = "iw/2-(iw/zoom/2)"
        y = "ih/2-(ih/zoom/2)"
...
Style: Dynamic,Arial,78,&H00FFFFFF,&H00FFFFFF,&H00101010,&H96000000,-1,0,0,0,100,100,0,0,3,3,0,2,100,100,330,1
Style: DynamicTop,Arial,78,&H00FFFFFF,&H00FFFFFF,&H00101010,&H96000000,-1,0,0,0,100,100,0,0,3,3,0,8,100,100,280,1
Style: Hook,Arial,92,&H00FFFFFF,&H00FFFFFF,&H00101010,&HA0000000,-1,0,0,0,100,100,0,0,3,4,0,2,90,90,300,1
Style: HookTop,Arial,92,&H00FFFFFF,&H00FFFFFF,&H00101010,&HA0000000,-1,0,0,0,100,100,0,0,3,4,0,8,90,90,250,1
