...
def apply_director_engine(storyboard, studio_profile=None):
    studio_profile = studio_profile or {}
    preferred_motions = studio_profile.get("preferred_motions", [])
    preferred_visuals = studio_profile.get("preferred_visual_types", [])
    ...
    for scene in storyboard.scenes:
        ...
        if preferred_visuals and visual_type not in preferred_visuals:
            visual_type = preferred_visuals[0]
